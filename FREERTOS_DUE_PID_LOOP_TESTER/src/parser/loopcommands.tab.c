...
#line 4 "loopcommands.y"

#include <stdio.h>
#include "loopcommands.h"

#line 76 "loopcommands.tab.c"
...
#ifndef YY_YY_LOOPCOMMANDS_TAB_H_INCLUDED
# define YY_YY_LOOPCOMMANDS_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 9 "loopcommands.y"

  int id;
  float f;
  int xk;

#line 142 "loopcommands.tab.c"
...
#endif /* !YY_YY_LOOPCOMMANDS_TAB_H_INCLUDED  */
/* Symbol kind.  */
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LOOPID = 4,                     /* LOOPID  */
  YYSYMBOL_ON = 5,                         /* ON  */
  YYSYMBOL_OFF = 6,                        /* OFF  */
  YYSYMBOL_XK = 7,                         /* XK  */
  YYSYMBOL_EOL = 8,                        /* EOL  */
  YYSYMBOL_SPEED = 9,                      /* SPEED  */
  YYSYMBOL_POSITION = 10,                  /* POSITION  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_command = 12,                   /* command  */
  YYSYMBOL_onoff = 13,                     /* onoff  */
  YYSYMBOL_xkseq = 14,                     /* xkseq  */
  YYSYMBOL_parameterList = 15,             /* parameterList  */
  YYSYMBOL_parameter = 16,                 /* parameter  */
  YYSYMBOL_xkset = 17                      /* xkset  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "LOOPID",
  "ON", "OFF", "XK", "EOL", "SPEED", "POSITION", "$accept", "command",
  "onoff", "xkseq", "parameterList", "parameter", "xkset", YY_NULLPTR
};
